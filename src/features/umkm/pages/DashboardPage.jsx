...
const activities = [
  {
    icon: Check,
    title: "AI klasifikasi 2 dokumen baru",
    meta: "Bahan Baku - Energi - 12 menit lalu",
    tone: "#4f8b5e",
  },
  {
    icon: Hash,
    title: "2 hash terdaftar on-chain",
    meta: "tx 0x9a12...ee04 - 2 jam lalu",
    tone: "#4f8b5e",
  },
  {
    icon: TrendingUp,
    title: "GRS naik 87 -> 90 (estimasi)",
    meta: "jika 1 dok Limbah selesai - besok",
    tone: "#c6763b",
  },
  {
    icon: Eye,
    title: "Profil dilihat 14x hari ini",
    meta: "dari Pulau Jawa",
    tone: "#7a5521",
  },
  {
    icon: MessageSquare,
    title: "Pesan WA baru dari pengunjung",
    meta: "Pak Joko, PT Cintya - 4 jam lalu",
    tone: "#2f9f67",
  },
];
...
const StatCard = ({ label, value, footer }) => (
  <section className="rounded-[18px] border border-[#ddd6ca] bg-white p-6 shadow-[0_16px_34px_rgba(21,24,18,0.04)]">
    <div className="text-[0.7rem] font-semibold uppercase tracking-[0.34em] text-[#8d877f]">
      {label}
    </div>
    <div
      className="mt-20 text-[3.2rem] leading-none tracking-[-0.07em] text-[#181816]"
    ...
    <div className="min-h-screen bg-[#fbfaf7] text-[#20201c]">
      <header>
        <div className="px-6 py-3 lg:px-12">
          <h1
            className="m-0 text-[2.35rem] leading-none tracking-[-0.06em] text-[#181816]"
            
          >
            Dashboard.
          </h1>
          <p className="mt-3 text-[0.98rem] font-medium text-[#5f5a53]">
            Selamat siang, Siti. GRS Anda naik 5 poin minggu ini.
          </p>
        </div>
      </header>
      ...
      <main className="px-6 py-7 lg:px-12">
        <div className="grid gap-6 xl:grid-cols-[minmax(0,1.45fr)_minmax(250px,0.9fr)_minmax(250px,0.9fr)]">
            ...
            <div className=" gap-6 sm:items-center">
              <div className="flex">
                ...
                >
                  ...
                  <circle
                    ...
                    strokeDashoffset={`${2 * Math.PI * 66 * 0.13}`}
                  />
                </svg>
              ...
              <div>
                ...
                <p className="mt-4 max-w-[25rem] text-xs font-medium leading-6 text-[#5f5a53]">
                  Passport Anda{" "}
                  <span className="font-bold text-[#20201c]">aktif</span> dan
                  tampil di landing page. Tambah 1 dokumen Limbah lagi untuk
                  capai{" "}
                  <span className="font-bold text-[#c47739]">
                    Unggul (90+).
                  </span>
                </p>
              </div>
          ...
          <StatCard
            label="Dokumen On-Chain"
            value="18"
            footer="dari 20 total"
          />
          <StatCard
            label="Pengunjung 7 Hari"
            value="128"
            footer="+22% vs minggu lalu"
          />
        </div>
          ...
          <section className="rounded-[18px] border border-[#ddd6ca] bg-white p-6 shadow-[0_16px_34px_rgba(21,24,18,0.04)]">
            <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
              <div>
                ...
                <h2
                  className="mt-2 text-[1.35rem] leading-tight tracking-[-0.04em] text-[#181816]"
                ...
                return (
                  ...
                  >
                    ...
                    <div className="min-w-0">
                      <div className="truncate text-[0.9rem] font-bold text-[#20201c]">
                        {category.name}
                      </div>
              ...
              {activities.map((activity) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="min-w-0">
                      <div className="truncate text-[0.92rem] font-bold text-[#20201c]">
                        {activity.title}
                      </div>
                      <div className="truncate text-[0.78rem] font-semibold text-[#8d877f]">
                        {activity.meta}
                      </div>
                    </div>
                  </div>
        ...
        <section className="mt-6 rounded-[18px] border border-[#ddd6ca] bg-white p-5 shadow-[0_16px_34px_rgba(21,24,18,0.04)] xl:hidden">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-[0.92rem] font-bold text-[#20201c]">
                Proposal masuk
              </div>
              <div className="text-[0.78rem] font-semibold text-[#8d877f]">
                1 pesan baru menunggu balasan
              </div>
            </div>
          </div>
        </section>
