// GreenTrust button variants
// Primary brand: Forest Green #205336
// Secondary brand: Gold #FDA800

export const PRESS_BUTTON_VARIANTS = {
  // Main CTA — Gold (secondary brand color)
  secondary: {
  ...
  // Outline green — ghost with green border
  outline: {
  ...
  // Outline gold — ghost with gold border
  'outline-orange': {
