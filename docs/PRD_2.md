...
| **3.0.0** | 20 Mei 2026 | Rebuild final: MVP \= UMKM-centric, landing page showcase, CTA WA, GRS threshold 70, OQ v3 terjawab. v4: Investor role MVP, KTP OCR, multi-produk, document visibility rules. | Khaizuran Alvaro |
...
GreenTrust Passport PRD v5.0 — AkademiCompe, Universitas Brawijaya — 2026
